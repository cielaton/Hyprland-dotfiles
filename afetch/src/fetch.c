...
int main()
{
	...
	printf("%s", info.col1);
	printf("%s    %s%s%s%s\n", info.col2, RED , UserText, TextColour, username);
	printf("%s    %s%s%s%s\n", info.col3, GREEN , OsText, TextColour, osname);
	pthread_join(threads[2], NULL);
	printf("%s    %s%s%s%s\n", info.col4, YELLOW, KernelText, TextColour, krnlver);
	pthread_join(threads[3], NULL);
	printf("%s    %s%s%s%ldh %ldm\n",info.col5 , BLUE, UptimeText, TextColour, uptimeH,
	       uptimeM);
	pthread_join(threads[4], NULL);
	printf("%s    %s%s%s%s\n",info.col6, MAGENTA, ShellText, TextColour, shellname);
